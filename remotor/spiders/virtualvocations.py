...
class VirtualvocationsSpider(scrapy.Spider):
    ...
    job_selector = '//a[starts-with(@href, "{0}/job/")]/@href'.format(root)
    ...
    def parse(self, response):
        ...
        pagelinks.extend(
            pagination.xpath('//a[contains(@href, "l-remote/p-")]/@href').extract()
        )
...
def test_parse_time():
    ...
    tests = [
        ("Posted: Monday, June 19, 2017", datetime.datetime(2017, 6, 19)),
